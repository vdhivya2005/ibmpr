...
Original file is located at
    https://colab.research.google.com/drive/1Syo5FNE8UsCyBEzGhJOxU9G1uZ5BQldU
"""
...
Original file is located at
    https://colab.research.google.com/drive/1Xyh7VPGtkicDslYNKj7sPTPnLAl-LKLk
"""
...
with gr.Blocks(title="SmartSDLC") as app:
    ...
    gr.Markdown("SMARTSDLC is an AI-driven platform that automates SDLC tasksâ€”like code generation, testing, and bug fixingâ€”using advanced AI.")
